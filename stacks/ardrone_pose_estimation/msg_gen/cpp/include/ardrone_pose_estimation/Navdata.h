/* Auto-generated by genmsg_cpp for file /home/futuhal57/ros/stacks/ardrone_pose_estimation/msg/Navdata.msg */
#ifndef ARDRONE_POSE_ESTIMATION_MESSAGE_NAVDATA_H
#define ARDRONE_POSE_ESTIMATION_MESSAGE_NAVDATA_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct Navdata_ {
  ...
  typedef boost::shared_ptr< ::ardrone_pose_estimation::Navdata_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ardrone_pose_estimation::Navdata_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct Navdata
typedef  ::ardrone_pose_estimation::Navdata_<std::allocator<void> > Navdata;

typedef boost::shared_ptr< ::ardrone_pose_estimation::Navdata> NavdataPtr;
typedef boost::shared_ptr< ::ardrone_pose_estimation::Navdata const> NavdataConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::ardrone_pose_estimation::Navdata_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::ardrone_pose_estimation::Navdata_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::ardrone_pose_estimation::Navdata_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::ardrone_pose_estimation::Navdata_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::ardrone_pose_estimation::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
    return "e1a345c5745bc369c951c1a2d81ecf13";
  }

  static const char* value(const  ::ardrone_pose_estimation::Navdata_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xe1a345c5745bc369ULL;
  static const uint64_t static_value2 = 0xc951c1a2d81ecf13ULL;
};

template<class ContainerAllocator>
struct DataType< ::ardrone_pose_estimation::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
    return "ardrone_pose_estimation/Navdata";
  }
...
template<class ContainerAllocator>
struct Definition< ::ardrone_pose_estimation::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
...
float32 vz\n\
\n\
#linear accelerations (unit: m/s^2)\n\
float32 ax\n\
float32 ay\n\
float32 az\n\
\n\
...
template<class ContainerAllocator> struct HasHeader< ::ardrone_pose_estimation::Navdata_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::ardrone_pose_estimation::Navdata_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::ardrone_pose_estimation::Navdata_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::ardrone_pose_estimation::Navdata_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::ardrone_pose_estimation::Navdata_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // ARDRONE_POSE_ESTIMATION_MESSAGE_NAVDATA_H
