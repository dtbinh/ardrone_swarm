"""autogenerated by genpy from ardrone_pose_estimation/Navdata.msg. Do not edit."""
import sys
...
class Navdata(genpy.Message):
  _md5sum = "e1a345c5745bc369c951c1a2d81ecf13"
  _type = "ardrone_pose_estimation/Navdata"
...
"""
  ...
  _slot_types = ['std_msgs/Header','float32','uint32','int32','int32','int32','int32','int32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','uint32','uint32[]','uint32[]','uint32[]','uint32[]','uint32[]','float32[]','float32[]','float32']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_fI5i13fI.pack(_x.batteryPercent, _x.state, _x.magX, _x.magY, _x.magZ, _x.pressure, _x.temp, _x.wind_speed, _x.wind_angle, _x.wind_comp_angle, _x.rotX, _x.rotY, _x.rotZ, _x.altd, _x.vx, _x.vy, _x.vz, _x.ax, _x.ay, _x.az, _x.tags_count))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.batteryPercent, _x.state, _x.magX, _x.magY, _x.magZ, _x.pressure, _x.temp, _x.wind_speed, _x.wind_angle, _x.wind_comp_angle, _x.rotX, _x.rotY, _x.rotZ, _x.altd, _x.vx, _x.vy, _x.vz, _x.ax, _x.ay, _x.az, _x.tags_count,) = _struct_fI5i13fI.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
...
_struct_fI5i13fI = struct.Struct("<fI5i13fI")
